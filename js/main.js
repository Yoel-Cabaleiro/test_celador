...
loadCSVByName('preguntas_celador_definitivo.csv').then(()=>{ renderTraining(); updateHardCount(); }).catch(err=>{ console.error('No se pudo cargar preguntas_celador_definitivo.csv', err); updateDatasetBadge('Error al cargar CSV'); });
